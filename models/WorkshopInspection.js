...
const VehicleSchema = new Schema(
  {
    brandId: {
      type: String,
      required: [true, "Die Marken-ID ist erforderlich."],
      trim: true,
    },

    brandLabel: {
      type: String,
      required: [true, "Der Markenname ist erforderlich."],
      trim: true,
    },

    name: {
      type: String,
      required: [true, "Die Fahrzeugbezeichnung ist erforderlich."],
      trim: true,
...
/*
  Allows multiple vehicles without a FIN,
  but prevents duplicate non-empty FIN values.
*/

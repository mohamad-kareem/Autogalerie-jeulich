...
export default function ScheinForm({
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Cloudinary upload (only if new file chosen)
      if (file) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/50 backdrop-blur-sm flex items-center justify-center p-3 sm:p-4">
      {/* Scrollable container for mobile + wider on desktop */}
      <div className="custom-scroll w-full max-w-5xl lg:max-w-6xl max-h-[90vh] overflow-y-auto px-3 sm:px-4 lg:px-6">
        <div className="overflow-hidden rounded-2xl bg-white shadow-2xl border border-gray-200">
          {/* Header */}
          <div className="flex items-center justify-between border-b border-gray-200 px-4 sm:px-6 py-1 sm:py-3">
            ...
            <button
              type="button"
              onClick={onClose}
              className="inline-flex h-8 w-8 sm:h-9 sm:w-9 items-center justify-center rounded-full text-gray-400 hover:bg-gray-100 hover:text-gray-700 transition-colors"
            >
              <FiX size={18} />
            </button>
          </div>
          ...
          >
            ...
            <div className="space-y-4 sm:space-y-5">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full h-10 rounded-md border border-gray-300 px-3 text-sm focus:border-gray-900 focus:ring-1 focus:ring-gray-900/10 outline-none transition"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full h-10 rounded-md border border-gray-300 px-3 text-sm focus:border-gray-900 focus:ring-1 focus:ring-gray-900/10 outline-none transition bg-white"
                  >
                    {OWNERS.map((o) => (
              ...
              <div>
                ...
                <div className="flex flex-col gap-3 rounded-lg border border-dashed border-gray-300 bg-gray-50/80 p-3 sm:p-4">
                  <div className="flex flex-col sm:flex-row items-stretch sm:items-start gap-3 sm:gap-4">
                    <div className="flex h-28 w-full sm:w-28 items-center justify-center overflow-hidden rounded-md border border-gray-300 bg-white">
                      {previewUrl ? (
                        <img
                          src={previewUrl}
                          alt="Vorschau"
                        ...
                        <div className="flex h-full w-full flex-col items-center justify-center text-gray-300 text-xs gap-1">
                          <FiImage size={20} />
                    ...
                    <div className="flex-1 space-y-2 text-xs sm:text-sm text-gray-600">
                      ...
                      <div className="flex flex-wrap gap-2">
                        <label className="inline-flex cursor-pointer items-center gap-1.5 rounded-md border border-gray-300 bg-white px-3 py-1.5 text-xs sm:text-sm font-medium text-gray-700 hover:bg-gray-100 transition">
                          <FiUpload size={14} />
                          <span>
                        ...
                        {previewUrl && (
                          <button
                            ...
                            className="inline-flex items-center gap-1.5 rounded-md border border-gray-200 bg-white px-3 py-1.5 text-xs sm:text-sm text-gray-600 hover:bg-gray-100 transition"
                          >
                            <FiX size={13} />
            ...
            <div className="flex flex-col justify-between gap-4 sm:gap-5">
              <div>
                ...
                <div className="flex flex-col sm:flex-row gap-2">
                  <input
                    ...
                    className="flex-1 h-9 rounded-md border border-gray-300 px-3 text-sm focus:border-gray-900 focus:ring-1 focus:ring-gray-900/10 outline-none transition"
                ...
                {tasks.length > 0 ? (
                  <>
                    ...
                    <ol className="max-h-64 sm:max-h-72 overflow-y-auto space-y-1.5 pr-1">
                      {tasks.map((task, idx) => (
                        <li
                          key={idx}
                        ...
                        >
                          ...
                          <div className="flex-1 flex items-start justify-between gap-2">
                            ...
                            <button
                              ...
                              className="mt-0.5 inline-flex items-center justify-center rounded-full text-gray-400 hover:text-gray-700 hover:bg-gray-100 p-0.5 transition"
                            >
                              <FiX size={11} />
                            </button>
                          </div>
              ...
              {/* Footer buttons */}
              <div className="mt-2 flex flex-col sm:flex-row sm:items-center justify-end gap-2 sm:gap-3 border-t border-gray-200 pt-3 sm:pt-4">
                <button
                  type="button"
                  onClick={onClose}
                  className="w-full sm:w-auto px-4 py-2 text-xs sm:text-sm rounded-md border border-gray-300 bg-white text-gray-700 hover:bg-gray-100 transition"
                >
                  Abbrechen
                </button>
                <button

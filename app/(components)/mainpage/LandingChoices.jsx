...
export default function LandingChoices() {
  ...
  return (
    <section className="relative w-full bg-gray-50 py-14 sm:py-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <div className="relative w-full max-w-[95vw] xl:max-w-[1280px] 2xl:max-w-[1536px] mx-auto px-4 sm:px-6 lg:px-8 py-16">
        {/* Heading */}
        <motion.div
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          >
            ...
            <div className="absolute bottom-0 left-0 right-0 p-6 text-white z-10">
              ...
              <Link
                href="/kontakt"
                className="inline-flex items-center gap-2 px-5 py-2.5   text-white text-sm sm:text-base font-medium rounded-lg transition"
              >
                Standort entdecken

...
export default function SchlüsselManagement() {
  ...
  const saveEdit = async () => {
    // Validate duplicate key number (exclude current)
    if (
      schlussels.some(
        (s) =>
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-orange-50 p-4 md:p-8 mt-10">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-300 to-orange-900 p-10 md:pl-17 mt-10">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
              ...
              <div className="p-4 border-b border-gray-100">
                <div className="relative">
                  ...
                  <input
                    ...
                    value={searchTerm}
                    onChange={onSearch}
                    placeholder="Suche nach Fahrzeugname..."
                    className="pl-10 pr-4 py-3 w-full border rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent text-sm transition-all duration-200"
                  />
                </div>
              </div>
              <div
                ...
                {filtered.length === 0 ? (
                  <div className="p-8 text-center">
                    <div className="text-gray-400 mb-3">
                      <FiKey className="inline-block text-4xl opacity-70" />
                    </div>
                    ...
                    {!searchTerm && (
                      <motion.button
                        ...
                        className="mt-4 text-orange-600 hover:text-orange-700 text-sm font-medium flex items-center justify-center gap-1 mx-auto"
                      >
                        <FiPlus /> Add your first key
                      </motion.button>
                    )}
                  </div>
                ) : (
                  <ul className="divide-y divide-gray-100">
                    {filtered.map((s) => (
                      <motion.li
                        ...
                        onClick={() => onSelect(s)}
                        className={`px-4 py-3 cursor-pointer transition-all hover:bg-orange-50 flex justify-between items-center ${
                          selected?._id === s._id
                ...
                {isAdding || isEditing ? (
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <input
                          ...
                          value={form.car}
                          onChange={onInput}
                          className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent text-sm transition-all"
                  ...
                  >
                    <div className="flex justify-between items-center mb-6">
                      ...
                      <button
                        onClick={startEdit}
                        className="text-gray-400 hover:text-orange-600 p-2 rounded-full hover:bg-gray-100 transition-colors"
                      >
                    ...
                    <div className="space-y-5">
                      ...
                      {selected.notes && (
                        <div>
                          ...
                          <p className="text-gray-800 whitespace-pre-line bg-orange-50 p-4 rounded-xl text-sm">
                            {selected.notes}
                          </p>
                        </div>
                      )}
                  ...
                  >
                    <div className="p-4 bg-orange-100 text-orange-400 rounded-full mb-4 opacity-70">
                      <FiKey className="text-3xl" />
                    </div>
                    <h3 className="text-base font-medium text-gray-700 mb-1">
                      {searchTerm
                        ? "Wähle einen Schlüssel, um Details anzuzeigen"
                        : "Kein Schlüssel ausgewählt"}
                    </h3>
                    <p className="text-gray-500 text-xs max-w-xs mb-4">
                      {searchTerm
                        ? "Wähle einen Eintrag aus den Suchergebnissen, um Informationen zum Schlüssel anzuzeigen"
                        : "Wähle einen Schlüssel aus der Liste oder füge einen neuen hinzu"}
                    </p>

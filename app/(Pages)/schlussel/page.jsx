...
export default function KeysPage() {
  ...
  // ---------- Auto Reset Brand- & Sold-Filter nach 60s ----------
  useEffect(() => {
                ...
                <div className="flex items-center gap-1">
                  ...
                  {filterBrand && (
                    <button
                      ...
                      className={`inline-flex items-center justify-center rounded-2xl border px-1 py-[2px] text-[9px] transition-colors duration-200 ${
                        darkMode

...
import Grid from "@/app/(components)/helpers/Grid";
const PublicAddCarPage = () => {
  return (
    <>
      <main className="min-h-screen bg-gradient-to-br from-black/95 to-red-950 ">
        {/* Hero Section */}
              ...
              <div className="bg-white rounded-xl md:rounded-2xl shadow-xl overflow-hidden border border-gray-100 transition-all duration-300 hover:shadow-2xl">
                <div className="bg-gradient-to-br from-black to-red-950 px-6 py-5 md:px-8 md:py-7">
                  ...
                  <p className="text-gray-300 font-light text-sm md:text-base">
                    Füllen Sie dieses Formular aus und erhalten Sie innerhalb
                    von 24 Stunden Ihr wettbewerbsfähiges Angebot
                  </p>
                </div>
        ...
        <div className="bg-gradient-to-b from-gray-100 to-white py-12 md:py-20 px-4 sm:px-6 border-t border-gray-100">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12 md:mb-16">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto text-sm md:text-base">
                ...
                ersten Wahl für anspruchsvolle Autoverkäufer in ganz
                Deutschland.
              </p>
            </div>

/**
 * Historical arrival-time heuristic, not a documented portal refresh contract.
 * Earlier observations suggested roughly two-minute clusters. They do not
 * establish whether caching, indexing, publication processing, or a combination
 * caused the delay, nor prove that every search follows the same schedule.
 * `nextCheckDelay` can use this prediction to bring a check forward, but never
 * to postpone normal live polling. No two-second delivery guarantee is implied.
 *
